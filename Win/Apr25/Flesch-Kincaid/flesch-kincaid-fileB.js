...
function fleschKincaid(file) {
    const reader = new FileReader();
  
    reader.onload = function(event) {
      const text = event.target.result;
      const results = fleschKincaidOriginal(text); // Call your original function
...
function fleschKincaidOriginal(text) {
...
let results = fleschKincaid(filePath)
console.log("Flesch Reading Ease Score:", results.readingEase);
console.log("Flesch-Kincaid Grade Level:", results.gradeLevel);